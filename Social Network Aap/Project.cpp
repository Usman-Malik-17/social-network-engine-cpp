...
Activity::Activity()
{
    ...
    strcpy_s(activities[0], strlen("is feeling") + 1, "is feeling");
    activities[1] = new char[strlen("is thinking about") + 1];
    strcpy_s(activities[1], strlen("is thinking about") + 1, "is thinking about");
    activities[2] = new char[strlen("is making") + 1];
    strcpy_s(activities[2], strlen("is making") + 1, "is making");
    activities[3] = new char[strlen("is celebrating") + 1];
    strcpy_s(activities[3], strlen("is celebrating") + 1,"is celebrating");
    type = 0;
    value = 0;
}
Activity::~Activity()
...
void Comments::SetId(char* buffer)
{
    ...
    strcpy_s(commentID, strlen(buffer) + 1, buffer);
...
void Comments::SetCommentDescription(char* buffer)
{
    ...
    strcpy_s(comment, strlen(buffer) + 1, buffer);
...
void Controller::LoadCommands(ifstream& fin)
{
    ...
    while (!fin.eof())
    {
        ...
        strcpy_s(commands[i], strlen(buffer) + 1, buffer);
        i++;
    }
